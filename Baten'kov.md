...
*"Угрюма **камера** замкнутая острога, как зверя дикого огромная берлога"*, *"Певец острожный смолк, но песни этой звуки, в замкнутой **камере** напомнив о разлуке"*.
  ...
  Если обратится к наглядным примерам, то на графиках мы можем увидеть следующее:
  1. График употребления слова **"камера"** показывает ![1800-1820 гг.](http://processing.ruscorpora.ru/graphic.xml?env=alpha&mode=graphic_main&mycorp=&mysent=&mysize=&mysentsize=&mydocsize=&dpp=100&spp=&spd=1&text=lexform&sort=i_year_created&g=i_year_created&lang=ru&nodia=1&startyear=1800&endyear=1820&smoothing=0&req=камера)
  На ![графике](http://search1.ruscorpora.ru/ngram.xml?mode=main&t1=камера&start=1800&end=1900&smoothing=0) можно увидеть, насколько частотным было употребление слова **"камера"** в текстах XIX века. Наибольшую популярность слово **"камера"** обретает в текстах, созданных в период с 1864 по 1867 гг. Надо, однако, сказать, что в то время, когда было написано стихотворение "Узник", слово **"камера"** являлось малоупотребляемым.
